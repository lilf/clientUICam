// gist from https://gist.github.com/antitoxic/9156ae5a4531fce46ad1

// add inline style for message display
...
Selectize.define('no_results', function( options ) {
    ...
    options = $.extend({
        ...
        html: function(data) {
            return '<div class="dropdown-empty-message" style="line-height:20px;padding:5px 8px">' + data.message + '</div>';
        }
    }, options );
